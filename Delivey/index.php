...
<body>
	<div class="container mb-4">
		<h1 class=" my-4 text-center text-warning">Pending Orders</h1>
		<div class="row">
			<?php
			include('../Admin/config.php');
			$sql = "SELECT * , `orderid` FROM `ordermaster` WHERE `deliveryboyid` = '$del_id' AND `isdelivered` = '0'  ORDER BY `orderid` DESC";
					...
					<div class="col-md-8" style="margin-bottom:40px;">
						<div class="card">
							<div>
									...
									<div class="d-flex justify-content-between align-items-center">
										...
										<h6>Status:
											...
											if ($row['orderstatus'] == 'Delivered') {
												echo '<span class="text-warning">Delivered</span>';
											}
											?>
										</h6>
									</div>
								...
								<div class="card-body">
									<p class="card-text">Order Time: <strong><?php echo $row['ordertime']; ?></strong></p>
								...
								<div class="card-body">
									...
									<button class="btn btn-success form-control mt-2">Deliver Order</button>
								</div>
