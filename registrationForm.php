...
<body>
			...
			<div class="col-sm-8 offset-sm-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 text-center mt-5">
				...
				<form action="backend_file.php" class="rounded bg-white shadow p-5" method="POST">
					...
					<div class="form-floating mb-3">
						...
						<input type="number" class="form-control" name="mob" placeholder="number" id="number" required>
					...
					<div class="form-floating mb-3">
						...
						<input type="number" class="form-control" placeholder="PIN CODE" value="412411" readonly name="pincode" required>
	...
	<script>
		...
		let verify = document.getElementById('number').value
		console.log(verify)
	</script>
