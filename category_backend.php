    ...
    if(isset($_POST['catname']) )
{
    ...
    $inseruser="INSERT INTO `categorymaster`(`categoryname`) VALUES ('$catname')";
...
//update party data
    if(isset($_POST['hidden_id']) && isset($_POST['upcatname']) )
{
   $updatelegerrecord="UPDATE `categorymaster` SET `categoryname`='$upcatname' WHERE `id`='$hidden_id'";
		...
		if(isset($_POST['deleteid']))
		{
		  ...
		  $sql="DELETE FROM `categorymaster` WHERE id='$deleteid'";
		  //echo($sql);
...
if (isset($_POST['updateid']))
	{
		...
		$selectquery="SELECT * FROM `categorymaster` where `id`='$itemid'";
