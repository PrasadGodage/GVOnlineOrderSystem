...
<body>
  ...
  <div class="container">
    ...
    <h6 class="mx-4">Category wise filter :</h6>
      <div class="btn-group">
        <button type="button" class="btn btn-warning dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">All Menu</button>
          ...
          <div class="col-6 col-lg-3">
            <form action="" method="POST">
               <div class="card food-card" height="">
                ...
                <img src="./Admin/<?php echo $row['itemimage']; ?>" class="card-img-top p-3 rounded-corner" alt="Food 1" width="80px" height="180px">
