...
//update party data
    ...
    if(isset($_POST['hidden_id']) && isset($_POST['upmenuname']) && isset($_POST['upmenuunit'])&& isset($_POST['upmenurate'])&& isset($_POST['upmenucategory']) && isset($_POST['disableitem']))

{

   $updatelegerrecord="UPDATE `itemmaster` SET `itemname`='$upmenuname',`unit`='$upmenuunit',`rate`='$upmenurate',`itemcategoryname`='$upmenucategory',`status`= '$disableitem' WHERE `itemid`='$hidden_id'";
