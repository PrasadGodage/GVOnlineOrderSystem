...
$catnameoption = '<option value="">--- Select Category ---</option>';
while ($row1 = mysqli_fetch_assoc($result1)) {
  $catnameoption .= '<option value="' . $row1['categoryname'] . '">' . $row1['categoryname'] . '</option>';
}
            ...
            while ($row = mysqli_fetch_array($res)) { ?>
              <tr>
                ...
                <td>
                  ...
                  &nbsp<button class="mt-1 btn btn-danger" onclick="deletedata(<?php echo $row['itemid']; ?>)">X</button>
                </td>
              </tr>
          <?php
              $num++;
...
<!-- model started -->
<div class="modal fade" id="updatemenumodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form action="">
          ...
          <label for="" class="mt-3">Show Item</label>
          <select name="" class="form-control" id="disableitem">
...
<script type="text/javascript">
  ...
  function updatemenu() {
    ...
    var disableitem = $('#disableitem').val();
