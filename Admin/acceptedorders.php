...
<div class="main-content">
  <section class="section">
    <div class="section-body">
      ...
      <h6 class="text-success">Accepted Orders</h6>
...
$selectmenulist="SELECT * FROM `ordermaster` where `orderstatus`='Accept'";
  ...
  $num=1;
    ...
    {?>
        <tr>
          ...
          <button class="btn btn-warning" onclick="setorderidtotxt(<?php echo $row['orderid']; ?>)">Assign delivery Boy</button>
          ...
          <td>
            <button class="btn btn-primary" onclick="getdata(<?php echo $row['orderid']; ?>)">View</button>
 ...
 $num=1;
   ...
   {?>
       <tr>
        ...
        <td><h6 class="text-success"><?php getdeliveryboynamebyid($con,$row['deliveryboyid']) ?></h6></td>
         </td><!-- <td><Select class="form-control" id="orderstatus" onchange="getstatus(<?php //echo $row['orderid']; ?>)"> -->
           <!-- <option value="open" <?php //if($row['orderstatus']=='open'){ ?> selected <?php //} ?>>Open</option> -->
           <!-- <option value="Accept" <?php// if($row['orderstatus']=='Accept'){ ?> selected <?php// } ?>>Accept</option>
           <option value="Assign" <?php //if($row['orderstatus']=='Assign'){ ?> selected <?php //} ?>>assign delivery Boy</option> -->
