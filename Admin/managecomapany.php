            ...
            <div class="card-footer text-right">
              ...
              <?php
               ...
               if ($rcname == "") {
                ...
                echo '<button class="btn btn-warning mr-1" name="updatecomapny" type="submit">Update Restaurant Details</button>';
              ...
              <?php $status = 0; ?>
              <a class="btn btn-danger" href="backend_file.php?disable=<?php echo $status; ?>" >Close Restaurant</a>
